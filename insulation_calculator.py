...
layout = [
    ...
    [sg.InputCombo(('Dapper Vest', 'Hibernation Vest', 'Puffy Vest', 'Breezy Vest', 'Rain Coat', 'None'),key='dress_input', enable_events=True)],
    [sg.Text('Choose your character:')],
    [sg.InputCombo(('Were-Woodie', 'Wilson (Tier 3 Beard)', 'Webber (Tier 3 Beard)', 'Wilson (Tier 2 Beard)', 'Webber (Tier 2 Beard)', 'Woodie', 'Wilson (Tier 1)', "Webber (Tier 1)", "Willow/Wes", 'Other character'), size=(20, 1), key='beard_input')],
    [sg.Text("Write your temperature:")],
    [sg.Input(key='degrees_input')],
